...
public abstract class GenericRobot {
    ...
    //Drive <editor-fold>
	public Logger<Integer>  leftDriveLogger = new Logger<>();
    public Logger<Integer> rightDriveLogger = new Logger<>();
    ...
    public final void   setDrivePower      (double leftMotor, double rightMotor) {
         leftDriveLogger.printIfChanged("Left  Driver Motor", doubleToPercent( leftMotor));
        rightDriveLogger.printIfChanged("Right Driver Motor", doubleToPercent(rightMotor));
