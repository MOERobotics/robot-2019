...
public class MASideAutoHatch extends GenericAuto {
    ...
    public void run() {
        ...
        switch (autoStep) {
            ...
            //roll forward until lidar hits 475 + spear out
            case 9:
                PIDElevator(elevatorFloor + 3,elevatorPID);
                PIDArm(armOut, armPID);
            ...
            //spear in and roll back for a second
            case 12:
                PIDElevator(elevatorFloor + 3, elevatorPID);
                PIDArm(armOut,armPID);
